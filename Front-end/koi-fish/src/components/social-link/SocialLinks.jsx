        ...
        return (
            <div className='fixed z-30 '>
                ...
                <Link
                    ...
                    className="fixed left-4 bottom-4 bg-white text-white"
                ...
                <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="fixed left-4 bottom-20 bg-blue-900 text-white rounded-full p-3 shadow-lg hover:bg-blue-600 transition duration-300"
                ...
                {/* Bot Chat Link */}
                <div className="fixed left-4 bottom-36 flex items-start space-x-2">
                    <button
                        className="bg-white text-white"
                        aria-label="Chat with us"
                        onClick={handleOpenChat}
                    >
                        <div className="overflow-hidden w-20 h-40">
                            <img
                ...
                {!isChatHidden && isChatOpen && ( // Kiểm tra trạng thái isChatHidden
                    <div className="bg-white shadow-lg rounded-lg fixed bottom-36 left-28">
