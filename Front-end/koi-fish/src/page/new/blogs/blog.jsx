...
export default function BlogPage() {
    ...
    const fetchBlogs = async () => {
        try {
            setLoading(true);
            const response = await axios.get(`http://localhost:8081/v1/post/getPost/2?page=${currentPage}&limit=${limit}`);
            setBlogsArticles(response.data.datas);
    ...
    return (
        <div className="min-h-screen relative">
            ...
            <div className='mt-8 font-semibold text-center text-6xl '>BLOG
