...
const koiDetails = () => {
  ...
  useEffect(() => {
    koiById(); // Fetch pond detail when component mounts
  }, []);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-gray-100">
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-4 mb-6">
                {koiDetail.colors &&
                  ...
                  colors
                    .filter((color) => koiDetail.colors.includes(color.name))
                    .map((color, index) => (
                      <div
                        key={index}
                      ...
                      <>
                        {React.createElement(
                          fitWithElements[koiDetail.elementID - 1].icon,
                          {
                            ...
                            style: {
                              color:
                                fitWithElements[koiDetail.elementID - 1].color,
                            },
                            className: "ml-2",
                          }
                        )}
      ...
      <div className="mt-12">
        <h2 className="text-3xl font-bold mb-6 text-gray-800">Related Kois</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {datas.map((koi, index) => (
            <a
              key={koi._id || index}
              href={`/koidetail/${koi._id}`}
